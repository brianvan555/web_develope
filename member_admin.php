...
<body>
	<nav class="navbar" role="navigation">
		<div class="container-fluid">	
			...
			<div align="right">
				<p>Hello admin</p><?php echo '<p id="time"></p><script type="text/javascript">
	...
	<div class="container-fluid" style="margin-top:-1%;">
		<ul class="nav nav-stacked col-xs-2 col-md-10 col-lg-2 vc" style="background-color: #4F4F4F;margin-left: -1%;">
			...
			<li data-toggle="collapse" data-target="#clas"><a href="#">課程管理<span class="caret"></span></a>
            ...
            <li data-toggle="collapse" data-target="#semi"><a href="#">會議管理<span class="caret"></span></a>
            	<ul id="semi" class="collapse place">
	            	<li><a href="#h2">會議管理系統</a></li>
	                <li><a href="#h21">會議報名管理</a></li>
            	</ul>
            </li>
