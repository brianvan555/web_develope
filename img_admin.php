			...
			<form action="" method="post">
				<div class="row" align="center">
					<div class="col-md-12">
						...
						<hr>
						<h2><b>各教室跑馬燈所選圖檔</b></h2>
						
						<input type="button" class="btn btn-warning btn-lg" value="管理站內圖檔" onclick="window.open('../imgscan.php','管理站內圖檔','_blank','resizable,height=260,width=370')">
					</div>
					...
					<div class="col-md-12 ss">
						...
						<input type="submit" name="btn" class="btn btn-warning btn-lg" value="確認刪除">
						<br><br>
						<table>
							<tr>
